...
displayV = [TestSuite.fromFolder(progDir),  TestSuite.fromPackage('cellLH'),  TestSuite.fromPackage('dataLH'),  ...
   ...
   TestSuite.fromPackage('inputLH'),  TestSuite.fromPackage('latexLH'),  TestSuite.fromPackage('markovLH'),  ...
